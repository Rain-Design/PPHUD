...
if not isfolder("PPHUD") then
    ...
    local Arrow =
        request({Url = "https://raw.githubusercontent.com/Rain-Design/PPHUD/main/Dropdown.png", Method = "GET"})
...
function library:Window(WindowArgs)
    ...
    Window.Main.InputBegan:Connect(
        function(input)
    ...
    Window.Main.InputChanged:Connect(
        function(input)
            ...
            task.spawn(
                function()
                    for _, v in pairs(Containers:GetChildren()) do
                        if v.ClassName == "Frame" and v ~= Left or v ~= Right then
                            v.Visible = false
                        end
                    end
            ...
            function SectionTable:Dropdown(Info)
                ...
                function DropdownTable:Toggle(bool)
                    ...
                    if State then
                        ...
                        Dropdown.DropdownFrame.Size =
                            UDim2.new(0, 175, 0, Dropdown.DropdownFrame.Size.Y.Offset + DropdownY)
